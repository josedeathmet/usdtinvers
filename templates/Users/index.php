        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('ref_code') ?></th>
                    <th><?= $this->Paginator->sort('referred_by') ?></th>
                    <th><?= $this->Paginator->sort('balance') ?></th>
                    <th><?= $this->Paginator->sort('investment_fund') ?></th>
                    <th><?= $this->Paginator->sort('daily_profit') ?></th>
                    <th><?= $this->Paginator->sort('referral_earnings') ?></th>
